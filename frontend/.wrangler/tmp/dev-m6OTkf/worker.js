...
// ../../../Users/GrantCampbell/AppData/Roaming/npm/node_modules/wrangler/templates/modules-watch-stub.js
...
// .wrangler/tmp/bundle-w7EmiI/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-w7EmiI/middleware-insertion-facade.js
init_modules_watch_stub();
...
TRANSFORMED CV:`;
      const geminiRes = await fetch(
        `${GEMINI_API_URL}${model || env.GEMINI_MODEL_NAME}:generateContent?key=${env.GEMINI_API_KEY}`,
        {
          method: "POST",
...
Do not add any conversational fluff or introductory/concluding remarks outside of this structured analysis. Output only the analysis.`;
    ...
    return (0, import_kv_asset_handler.serveStatic)(request, env.ASSETS, { mapRequestToAsset: /* @__PURE__ */ __name((req) => req, "mapRequestToAsset") });
  }
};

// ../../../Users/GrantCampbell/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
init_modules_watch_stub();
...
// ../../../Users/GrantCampbell/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
init_modules_watch_stub();
...
// ../../../Users/GrantCampbell/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/common.ts
init_modules_watch_stub();
